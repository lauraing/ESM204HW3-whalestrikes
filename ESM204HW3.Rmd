...
Respondents in the age to thirty group are 2.04% more likely to vote yes than respondents in the over sixty age group. <br>
Respondents in the age to forty group are 2.01% less likely to vote yes than respondents in the over sixty age group. <br>
Respondents in the age to fifty group are 0.10% more likely to vote yes than respondents in the over sixty age group. <br>
Respondents in the age to sixty group are 1.62% less likely to vote yes than respondents in the over sixty age group. <br>
Respondents in the poor income level are 0.27% more likely to vote yes than respondents in the middle income level. <br>
Respondents in the rich income level are 0.75% more likely to vote yes than respondents in the middle income level. <br>
Respondents in the very rich income level are 4.68% more likely to vote yes than respondents in the middle income level. <br>
Respondents in the one percent income level are 0.88% more likely to vote yes than respondents in the middle income level. <br>
For every 1 point increase in NEP (measure of environmental concern), there is a 1.59% greater chance of voting yes. <br>
For every $1 increase in bid (annual payment for household), there is a 0.11% less chance of voting yes. <br>
For every 1% increase in risk reduction level, there is a 0.07% greater chance of voting yes. <br>
